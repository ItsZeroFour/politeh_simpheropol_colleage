...
const ContactForm = () => {
  ...
  return <div className={style.contact}>
    ...
    <form className={style.form}>
      <input {...fullnameBind} type="text" className={style.input} placeholder='Ваше ФИО' />
      <input {...emailBind} type="text" className={style.input} placeholder='Ваш E-Mail' />
      <input {...themeBind} type="text" className={style.input} placeholder='Тема' />

      <textarea {...messageBind} className={style.input + ' ' + style.textarea} placeholder='Ваше сообщение...'/>
