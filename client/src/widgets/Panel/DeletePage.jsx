...
const DeletePage = () => {
  ...
  return (
    <div>
      <input value={textName}  onChange={(event)=>{customHook(event.target.value)}}  style={{backgroundColor: "#000"}} type="text" name="" id="" />
      <button onClick={()=>setData(textName)} htmlFor="">Найти страницу</button>
      {dataPage !== ""  && (
				<div>
					<button
						onClick={() => {
